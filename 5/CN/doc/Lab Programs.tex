...
\begin{document}
	...
	\begin{enumerate}[label=\arabic*. ]
		...
		\answer \inputminted{tcl}{../final/Lab1.tcl} \newpage
		\Out
			\inputminted{text}{out/1.out}
			\begin{itemize}[label=,itemsep=1in]
				\centering
				\item \includegraphics[scale=.4]{../final/out/out1.dark.png}
				\item \includegraphics[scale=.4]{../final/out/out1.1.dark.png}
				\item \includegraphics[scale=.4]{../final/out/out1.2.dark.png}
			\end{itemize}
		\newpage
		...
		\answer \inputminted{tcl}{../final/Lab2.tcl} \newpage
		\Out
			\inputminted{text}{out/2.out}
			\begin{center}
				\includegraphics[scale=.5]{../final/out/out2.dark.png}
			\end{center}
		\newpage
		...
		\answer \inputminted{tcl}{../final/Lab3.tcl}
		\newpage

		\question{Develop a program for error detecting code using CRC-CCITT (16-bits).}{ }
		\answer \inputminted{java}{../final/CRC.java}
		\newpage
		...
		\answer \inputminted{java}{../final/BellmanFord.java}
		\newpage
		...
		\answer \subsection*{TCP Client}
				\inputminted{java}{../final/TCPClient.java}
				\subsection*{TCP Server}
				\inputminted{java}{../final/TCPServer.java}
		\newpage
		...
		\answer \inputminted{java}{../final/RSA.java}
		\newpage

		\question{Develop a program for congestion control using a leaky bucket algorithm.}{ }
		\answer \inputminted{java}{../final/LeakyBucket.java}
		\newpage
	\end{enumerate}
\end{document}
