...
-- Use rollback and Check the result
...
insert into Employee values(103,'Ganesh','Trainee',40,15000,50);
commit;

insert into Employee values(104,'Gaana','Trainee',40,15000,50);
select * from Employee;
...
insert into Employee values(105,'Karan','Trainee',40,null,50);
